...
- **月額** 約 1,200 円（追跡 2 日・1 日 21〜28 投稿での実測値からの試算）
...
| --- | --- | --- |
| 1,000 以上 | （なし） | 2.9 件/日 |
| 2,000 以上 | `【要チェック】` | 1.9 件/日 |
| 4,000 以上 | `【要注意！！】` | 0.3 件/日 |

**この頻度は追跡 4 日で集めた実測から出している**（[ADR-0008](docs/50-adr/adr-0008-raise-thresholds.md)）。
追跡が 2 日になった後で測り直していないので、**実際はこれより少ない。**
